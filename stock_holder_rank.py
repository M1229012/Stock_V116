...
def build_rank_image(listed_df, otc_df, display_date, main_title="每週大股東籌碼強勢榜  Top 20"):
    ...
    draw_text(ax, 0.872, 0.921, "股權分散｜400張以上比例", size=14.2,
    ...
    draw_text(ax, 0.966, 0.026, "資訊分享非投資建議｜投資請自行評估風險",
              size=12.2, color=TEXT_MUTED, ha="right")
    draw_text(ax, 0.982, 0.008, clean_cell(TOPRIGHT_WATERMARK_TEXT),
              size=10.5, color=TEXT_MUTED, ha="right", va="bottom")
